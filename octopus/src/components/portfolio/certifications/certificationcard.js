...
export function CertificationInfoCard({ user_id }) {
          ...
          <div
            ...
            onClick={function () {
              setUserdata({
                ...
                date_validate: formDate(data.date_validate),
              });
              setMode("UPDATE");
            }}
          >
  ...
  function PostData() {
    axios
      .post(`${Url}/certificationsinfo/${user_id}`, userdata, {
  ...
  function PutData() {
    axios
      .put(`${Url}/certificationsinfo/${user_id}`, userdata, {
        headers: { Authorization: "Bearer " + localStorage.getItem("jwt") },
      })
      .then((response) => {
        setList(response.data.result);
  ...
  function DeleteData() {
    axios
      .delete(`${Url}/certificationsinfo/${user_id}`, {
        headers: { Authorization: "Bearer " + localStorage.getItem("jwt") },
      })
      .then((response) => {
        setList(response.data.result);
  ...
  if (user_id === login_id) {
    ...
    return (
      <div>
        <div className="card-body">{certificationList}</div>
      </div>
    );
  }
}
